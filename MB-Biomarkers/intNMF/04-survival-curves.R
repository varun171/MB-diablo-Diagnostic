...
pdf(file = file.path(plots_dir, "survival_methyl_subtype_v11.pdf"), height = 8, width = 10, onefile = FALSE)
p <- ggsurvplot(fit,
...
pdf(file = file.path(plots_dir, "survival_methyl_subtype_v12.pdf"), height = 8, width = 10, onefile = FALSE)
p <- ggsurvplot(fit,
                title = "Survival stratified by Methylation-derived molecular subtypes",
                data = surv_data,
                font.x = c(12, face = "bold"),
...
# survival curves stratified by intNMF subtypes
